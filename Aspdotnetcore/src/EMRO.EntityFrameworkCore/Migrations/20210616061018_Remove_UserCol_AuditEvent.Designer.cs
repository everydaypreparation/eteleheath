...
namespace EMRO.Migrations
{
    ...
    [Migration("20210616061018_Remove_UserCol_AuditEvent")]
    partial class Remove_UserCol_AuditEvent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EMRO.AuditReport.AuditEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EMRO.DiagnosticsRequestTest.RequestTest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("RequestTestId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EMRO.Patients.IntakeForm.UserConsentPatientsDetails", b =>
                {
                    ...
                    b.Property<string>("ConsultantReportsIds")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EMRO.SurveyForm.SurveyQuestionMaster", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("SurveyQuestionMaster");
                });

            modelBuilder.Entity("EMRO.SurveyForm.SurveyResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EMRO.SurveyForm.SurveyResponse", b =>
                {
                    b.HasOne("EMRO.SurveyForm.SurveyQuestionMaster", "SurveyQuestionMaster")
                        .WithMany()
