      ...
      .subscribe(
        (res: any) => {
          try {
            ...
            console.log("Success Exception InsuranceDashboardComponent getUserDetailsById " + e);
          }
        ...
        (err: any) => {
          try {
            this.stickyBarService.hideLoader("");
            console.log("Error InsuranceDashboardComponent getUserDetailsById " + JSON.stringify(err));
            this.apiService.catchError(err);
          } catch (e) {
            console.log("Error Exception InsuranceDashboardComponent getUserDetailsById " + e);
          }
        }
      );
  }
      ...
      .subscribe(
        (res: any) => {
          try {
            ...
            console.log("Success Exception InsuranceDashboardComponent getWeather " + e);
          }
          this.stickyBarService.hideLoader("");
        },
        (err: any) => {
          try {
            this.stickyBarService.hideLoader("");
            console.log("Error InsuranceDashboardComponent getWeather " + JSON.stringify(err));
            this.apiService.catchError(err);
          } catch (e) {
            console.log("Error Exception InsuranceDashboardComponent getWeather " + e);
          }
        }
      );
  }
