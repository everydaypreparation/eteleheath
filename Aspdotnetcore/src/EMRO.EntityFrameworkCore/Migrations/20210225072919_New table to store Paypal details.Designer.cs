...
namespace EMRO.Migrations
{
    ...
    [Migration("20210225072919_New table to store Paypal details")]
    partial class NewtabletostorePaypaldetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EMRO.Patients.IntakeForm.UserConsentFamilyDoctorsDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("UserConsentFamilyDoctorsDetailsId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserConsentFamilyDoctorsDetails");
                });
            ...
            modelBuilder.Entity("EMRO.PayPal.UserAppointmentPayPal", b =>
                {
                    ...
                    b.Property<DateTime>("PaymentOrderId")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("EMRO.UserConsents.UserConsent", b =>
                {
                    ...
                    b.Property<Guid?>("UserConsentFamilyDoctorsDetailsId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserConsentFamilyDoctorsDetailsId");
            ...
            modelBuilder.Entity("EMRO.UsersMetaInfo.UserMetaDetails", b =>
                {
                    ...
                    b.Property<string>("DoctorPostalCodes")
                        .HasColumnType("text");

                    b.Property<string>("DoctorState")
                        .HasColumnType("text");

                    b.Property<string>("DoctorTelePhone")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EMRO.Patients.IntakeForm.UserConsentFamilyDoctorsDetails", b =>
                {
                    ...
                    b.HasOne("EMRO.Patients.IntakeForm.UserConsentPatientsDetails", "Patients")
                        .WithMany()
            ...
            modelBuilder.Entity("EMRO.UserConsents.UserConsent", b =>
                {
                    ...
                    b.HasOne("EMRO.Patients.IntakeForm.UserConsentFamilyDoctorsDetails", "UserConsentFamilyDoctorsDetails")
                        .WithMany()
                        .HasForeignKey("UserConsentFamilyDoctorsDetailsId");
