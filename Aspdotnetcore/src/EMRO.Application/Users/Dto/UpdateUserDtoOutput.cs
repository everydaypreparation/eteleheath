...
{
    public class UpdateUserDtoOutput
    {
    ...
    public class PatientUpdateUserDtoOutput
    {
        public Guid UserId { get; set; }
    ...
    public class FamilyUpdateUserDtoOutput
    {
        public Guid UserId { get; set; }
    ...
    public class DiagnosticUpdateUserDtoOutput
    {
        public Guid UserId { get; set; }
    ...
    public class InsuranceUpdateUserDtoOutput
    {
        public Guid UserId { get; set; }
