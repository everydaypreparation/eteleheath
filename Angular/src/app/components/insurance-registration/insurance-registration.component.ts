...
export class InsuranceRegistrationComponent implements OnInit {
  ...
  createUser(): void {
    ...
    this.apiService
      .postFormDataWithBearer(this.apiConfig.createInsurance, formdata)
      .subscribe(
        (res: any) => {
          try {
            ...
            if (res.result.statusCode == 200) {
              ...
              this.router.navigate([this.routeConfig.adminInsurancesPath]);
            } else {
              this.stickyBarService.showErrorSticky(res.result.message);
            }
          } catch (e) {
            console.log("Success Exception InsuranceRegistrationComponent createUser " + e);
          }
        },
        (err: any) => {
          try {
            this.stickyBarService.hideLoader("");
            console.log("Error InsuranceRegistrationComponent createUser " + JSON.stringify(err));
            this.apiService.catchError(err);
          } catch (e) {
            console.log("Error Exception InsuranceRegistrationComponent createUser " + e);
          }
        }
      );
  }
  ...
  updateUser(): void {
    ...
    this.apiService
      .putFormDataWithBearer(this.apiConfig.updateInsurance, formdata)
      .subscribe(
        (res: any) => {
          try {
            this.stickyBarService.hideLoader("");
            ...
            console.log("Success Exception InsuranceRegistrationComponent updateUser " + e);
          }
        },
        (err: any) => {
          try {
            this.stickyBarService.hideLoader("");
            console.log("Error InsuranceRegistrationComponent updateUser " + JSON.stringify(err));
            this.apiService.catchError(err);
          } catch (e) {
            console.log("Error Exception InsuranceRegistrationComponent updateUser " + e);
          }
        }
      );
  }
      ...
      .subscribe(
        (res: any) => {
          try {
            ...
            console.log("Success Exception InsuranceRegistrationComponent getUserDetailsById " + e);
          }
          this.stickyBarService.hideLoader("");
        },
        (err: any) => {
          try {
            this.stickyBarService.hideLoader("");
            console.log("Error InsuranceRegistrationComponent getUserDetailsById " + JSON.stringify(err));
            this.apiService.catchError(err);
          } catch (e) {
            console.log("Error Exception InsuranceRegistrationComponent getUserDetailsById " + e);
          }
        }
      );
  }
