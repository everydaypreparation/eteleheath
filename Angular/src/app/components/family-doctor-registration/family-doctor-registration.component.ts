...
@Component({
  selector: 'app-family-doctor-registration',
  templateUrl: './family-doctor-registration.component.html',
  styleUrls: ['./family-doctor-registration.component.scss']
})
export class FamilyDoctorRegistrationComponent implements OnInit {
  ...
  createUser(): void {
    ...
    this.apiService
      .postFormDataWithBearer(this.apiConfig.createFamilyDoctor, formdata)
      .subscribe(
        (res: any) => {
          try {
            if (res.result.statusCode == 200) {
              ...
              this.router.navigate([this.routeConfig.adminFamilyDoctorsPath]);
            } else {
              this.stickyBarService.showErrorSticky(res.result.message);
            }
          } catch (e) {
            console.log("Success Exception FamilyDoctorRegistrationComponent createUser " + e);
          }
        ...
        (err: any) => {
          try {
            this.stickyBarService.hideLoader("");
            console.log("Error FamilyDoctorRegistrationComponent createUser " + JSON.stringify(err));
            this.apiService.catchError(err);
          } catch (e) {
            console.log("Error Exception FamilyDoctorRegistrationComponent createUser " + e);
          }
        }
      );
  }
  ...
  updateUser(): void {
    ...
    this.apiService
      .putFormDataWithBearer(this.apiConfig.updateFamilyDoctor, formdata)
      .subscribe(
        (res: any) => {
          try {
            this.stickyBarService.hideLoader("");
            ...
            console.log("Success Exception FamilyDoctorRegistrationComponent updateUser " + e);
          }
        },
        (err: any) => {
          try {
            this.stickyBarService.hideLoader("");
            console.log("Error FamilyDoctorRegistrationComponent updateUser " + JSON.stringify(err));
            this.apiService.catchError(err);
          } catch (e) {
            console.log("Error Exception FamilyDoctorRegistrationComponent updateUser " + e);
          }
        }
      );
  }
      ...
      .subscribe(
        (res: any) => {
          try {
            ...
            console.log("Success Exception FamilyDoctorRegistrationComponent getUserDetailsById " + e);
          }
          this.stickyBarService.hideLoader("");
        },
        (err: any) => {
          try {
            this.stickyBarService.hideLoader("");
            console.log("Error FamilyDoctorRegistrationComponent getUserDetailsById " + JSON.stringify(err));
            this.apiService.catchError(err);
          } catch (e) {
            console.log("Error Exception FamilyDoctorRegistrationComponent getUserDetailsById " + e);
          }
        }
      );
  }
