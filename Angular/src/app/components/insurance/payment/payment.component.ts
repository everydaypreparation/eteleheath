...
export class PaymentComponent implements OnInit {
          ...
          try {
            ...
            if (res.result.statusCode == 200) {
              ...
              this.router.navigate([
                this.routeConfig.insurancePaymentDetailsPath, this.appointmentId, this.paymentId, this.doctorId, verify
              ]);
            }
          } catch (e) {
  ...
  moveIntackForm(){
    this.router.navigate([this.routeConfig.insurancePatientInfoFormPath, this.appointmentId, this.doctorId]);
  }
}