...
export class DiagnosticRegistrationComponent implements OnInit {
  ...
  createUser(): void {
    ...
    this.apiService
      .postFormDataWithBearer(this.apiConfig.createDiagnostic, formdata)
      .subscribe(
        (res: any) => {
          try {
            ...
            if (res.result.statusCode == 200) {
              ...
              this.router.navigate([this.routeConfig.adminDiagnosticsPath]);
            } else {
              this.stickyBarService.showErrorSticky(res.result.message);
            }
          } catch (e) {
            console.log("Success Exception DiagnosticRegistrationComponent createUser " + e);
          }
        },
        (err: any) => {
          try {
            this.stickyBarService.hideLoader("");
            console.log("Error DiagnosticRegistrationComponent createUser " + JSON.stringify(err));
            this.apiService.catchError(err);
          } catch (e) {
            console.log("Error Exception ConsultantRegistrationComponent createUser " + e);
          }
        }
      );
  }
      ...
      .subscribe(
        (res: any) => {
          try {
            ...
            console.log("Success Exception DiagnosticRegistrationComponent updateUser " + e);
          }
        },
        (err: any) => {
          try {
            this.stickyBarService.hideLoader("");
            console.log("Error DiagnosticRegistrationComponent updateUser " + JSON.stringify(err));
            this.apiService.catchError(err);
          } catch (e) {
            console.log("Error Exception DiagnosticRegistrationComponent updateUser " + e);
          }
        }
      );
  }
      ...
      .subscribe(
        (res: any) => {
          try {
            ...
            console.log("Success Exception DiagnosticRegistrationComponent getUserDetailsById " + e);
          }
          this.stickyBarService.hideLoader("");
        },
        (err: any) => {
          try {
            this.stickyBarService.hideLoader("");
            console.log("Error DiagnosticRegistrationComponent getUserDetailsById " + JSON.stringify(err));
            this.apiService.catchError(err);
          } catch (e) {
            console.log("Error Exception DiagnosticRegistrationComponent getUserDetailsById " + e);
          }
        }
      );
  }
