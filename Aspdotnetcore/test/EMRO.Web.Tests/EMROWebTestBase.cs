...
{
    public abstract class EMROWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EMROWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EMROWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EMRODbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EMRODbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EMRODbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EMRODbContext, Task<T>> func)
        {
            T result;
